      ...
      <div className="flex-1 flex items-center justify-center relative">
        <div className="relative mix-blend-screen w-full h-full flex items-center justify-center">
          ...
          <a
            ...
            className="relative bg-black text-white mix-blend-multiply flex items-center justify-center w-full h-full group"
          >
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            {[
              ...
              { name: 'YouTube', icon: Youtube, href: 'https://www.youtube.com/channel/UCba9zv7ESBKjyayDc6CNekQ' },
