      ...
      <div className="relative w-[100vw] left-[calc(-50vw+50%)] right-[calc(-50vw+50%)] cursor-default">
        ...
        >
          <div className="text-center mb-8 cursor-default">
            {mounted ? (
              <TextCursorProximity
                label="Turning Bright Ideas into Brilliant Realities"
              ...
              <h1 className="text-4xl md:text-6xl font-bold cursor-default">
                Turning Bright Ideas into Brilliant Realities
              </h1>
            )}
          </div>
          <p className="text-xl text-center max-w-3xl mx-auto">
            Our Innovation Studio is where &apos;What&apos;s next?&apos; meets
            &apos;Let&apos;s do it!&apos;. We bridge the gap between imagination
            and execution, providing you with the resources to make your next
            big leap.
          </p>
        </section>
      </div>
